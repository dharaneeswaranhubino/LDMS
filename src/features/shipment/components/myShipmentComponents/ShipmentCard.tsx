...
const ShipmentCard = ({ item, onView }: Props) => {
  ...
  const priority = (item.shipmentPriority ??
    "STANDARD") as PriorityType;
  ...
  return (
    <div className="bg-white/90 border border-slate-200 rounded-2xl px-5 py-4 flex items-start justify-between shadow-sm hover:shadow-md transition-all">
        ...
        <p className="flex flex-wrap gap-2 items-center text-[13px] font-semibold text-slate-800 mb-1">
          ...
          {item.isFragile && (
            <span className="px-2 h-[22px] rounded-full text-[11px] font-semibold flex items-center bg-yellow-50 text-yellow-600 border border-yellow-200">
              {/* <i className="fa-solid fa-wine-glass-crack mr-1 text-[10px]" /> */}
              {/* <i className="fa-solid fa-glass-water mr-1 text-[10px]" /> */}
              {/* <i className="fa-solid fa-box-open mr-1 text-[10px]" /> */}
