                ...
                {[
                  ...
                  <div key={i} className="flex gap-2 items-stretch">
                    <div className="flex flex-col items-center">
                      ...
                      >
                        <i
                          className={`fa-solid ${cp.done ? "fa-check" : cp.active ? "fa-truck" : "fa-circle"} text-[8px]`}
                        />
                      </div>
                      {i < arr.length - 1 && (
                        <div
                          className={`w-px flex-1 min-h-[12px] my-[2px] ${cp.done ? "bg-green-300" : "bg-slate-200"}`}
                        />
                      )}
                    </div>
                    <div
                    ...
                    >
                      ...
                      {cp.active && (
                        <button
                          onClick={() =>
                            navigate(`/agent/delivery/${activeDelivery.id}`)
                          }
